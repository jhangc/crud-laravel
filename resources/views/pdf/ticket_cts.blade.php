...
<body>
    <div class="ticket">
        ...
        <table class="kv">
            ...
            <tr><td class="l">DNI</td><td class="r">{{ $desembolso->ctsUsuario->user->dni }}</td></tr>
            <tr><td colspan="2" class="l">Nombres: <span style="font-weight:normal">{{ $desembolso->ctsUsuario->user->name }}</span></td></tr>
