...
<head>
    <meta charset="UTF-8">
    <title>Cronograma de Créditos Nuevo</title>
    <style>
        body {
...
<body>
    ...
    @else
    <h3 style="text-align: center;">Nuevo Cronograma</h3>
    @endif
    @if($prestamo->categoria == 'grupal')
    ...
    <table style="border: none !important; width: 100%; margin-bottom:0px">
        ...
        <tr>
            <td><b>Nombre del grupo:</b></td>
            <td> @if($prestamo->categoria == 'grupal'){{ $prestamo->nombre_prestamo }}@else Crédito Individual @endif </td>
            <td><b>Moneda:</b></td>
            <td>Soles</td>
            <td><b>Desembolso (S/.):</b></td>
        ...
        <tr>
            <td><b>Asesor de Crédito:</b></td>
            <td>{{ $responsable->name }}</td>
            <td> @if($prestamo->categoria == 'grupal') <b>Código: @endif</b></td>
            <td>
                @if($prestamo->categoria == 'grupal')
    ...
    <div class="firma">
        <table class="firma-table" style="width: 100%;">
            <tr>
                ...
                <td style="width:50%; text-align:center;">__________________________<br>Cliente<br>{{ $cliente->nombre }}</td>
            </tr>
        </table>
    </div>
    @endforeach
