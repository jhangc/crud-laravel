    ...
    @foreach ($data as $item)
        <div class="ticket">
            ...
            <div class="content">
                ...
                <p><span class="label">DNI:</span> <span class="value">{{ $item['cliente']->documento_identidad ?? 'N/A' }}</span></p>
                <p><span class="label">Nombres:</span> <span class="value">{{ $item['cliente']->nombre ?? 'N/A' }}</span></p>
