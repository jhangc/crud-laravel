...
<body>
    ...
    CONTRATO CRÉDITO GRUPAL<br><br>Conste por el presente documento el Contrato CREDITO GRUPAL (en adelante EL CRÉDITO)
    que celebra, de una parte, Grupo CrediPalmo SAC, con R.U.C. Nro. 20610069542, con domicilio para los efectos del
    ...
    y de la otra parte EL CLIENTE (en adelante se denominará EL GRUPO:……………………………….. , cuyos datos de identificación se
    ...
    aplicables a la operatividad financiera denominada CREDITO GRUPAL (en adelante “EL CRÉDITO”).<br><br>Para iniciar
    con el contrato de EL CRÉDITO, Grupo CrediPalmo, debe comprobar la identidad de los miembros de EL GRUPO, quienes
    dejaran constancia de la aceptación del presente contrato, así como también, de cualquier otra información que
    corresponda, lo que implica, además, el ingreso de nuevos integrantes. <br>Los documentos que forman el presente
    contrato y del expediente del grupo son:<br>Documento de identidad.<br>Hoja Resumen.<br>Solicitud del
    crédito.<br>Cronograma.<br>Documentos de garantía y seguro (cuando correspondan).<br>Evaluación
    crediticia.<br><br>PRIMERO, SOBRE EL CRÉDITO: La entidad financiera Grupo CrediPalmo, otorgará al GRUPO, previa
    ...
    crediticias adquiridas, siendo EL GRUPO, entendido como un todo, el sujeto pasivo del crédito.<br>Los integrantes
    que conforman EL GRUPO, se encuentran detallados en la cartilla de identificación que forman parte del presente
    contrato.<br>Se precisa que, para todos los efectos del presente contrato, tales como cancelación, ejecución de pago
    anticipados o cualquier otra ejecución contractual el cliente es EL GRUPO: …………………………………………...<br><br>SEGUNDO, SOBRE
    EL GRUPO Y SU REPRESENTACIÓN: El grupo tendrá la denominación consignada en el presente contrato y la elección de
    sus miembros será atribución de EL GRUPO: ………………………………………...<br><br>EL GRUPO, por mayoría de votos ha designado a
    quienes conformaran el denominado “EL COMITÉ”, el cual estará integrado por el presidente, tesorero y secretario,
    ...
    contrato.<br>En ese sentido, EL COMITÉ, será quien represente al GRUPO, de acuerdo a lo dispuesto por el artículo N°
    155 del Código Civil, pudiendo efectuar las siguientes operaciones: <br>Suscribir los documentos contractuales de EL
    CRÉDITO con Grupo CREDIPALMO SAC, indicado en el presente documento, así como; suscribir la solicitud de
    refinanciamiento, reprogramación, congelamiento de EL CRÉDITO otorgado a EL GRUPO y/u otras operaciones que
    requieran.<br>Realizar operaciones de pago de EL CRÉDITO, según el cronograma de pago correspondiente, ello no
    siendo restrictivo para que el resto de integrantes puedan realizar dicha operación.<br>Elección del mecanismo de
    desembolso de EL CRÉDITO<br>Recibir toda clase de comunicaciones emitidas por Grupo CrediPalmo. Dicha facultad no
    enerva la responsabilidad de Grupo CrediPalmo sobre el deber de informar los cambios contractuales u otros aspectos
    a EL GRUPO, de acuerdo a la normativa aplicable<br>Otras facultades que se le otorguen.<br><br>TERCERO, SOBRE LA
    SOLIDARIDAD: Conforme a lo indicado en la cláusula primera, los miembros de EL GRUPO, reconocen que se convierten en
    ...
    comisiones y gastos de toda clase que se deriven de este Contrato, sin reserva ni limitación alguna. <br>Además, los
    avales solidarios por medio de la presente cláusula intervienen como avales solidarios las personas consignadas al
    ...
    se encuentran descritas en los anexos del presente contrato.<br><br><br>La entidad financiera, trasladará el cobro
    de gastos y comisiones a EL GRUPO, según lo señalado en el Art. 16 del Reglamento de Gestión de Conducta de Mercado
    del Sistema Financiero (RGCM). Siendo en tal sentido, que el cobro de comisiones y/o gastos procede conforme a lo
    dispuesto en el precitado marco normativo.<br><br>CUARTO, SOBRE EL DESEMBOLSO DE LOS CRÉDITOS: Grupo CrediPalmo
    pondrá a disposición de EL GRUPO los siguientes mecanismos de desembolso de EL CRÉDITO a elección de los integrantes
    de EL GRUPO: ……………………………….<br><br>Efectivo.<br>Cheque girado a la orden de cada integrante de EL GRUPO.<br>Dinero
    electrónico de contar con una Billetera Electrónica.<br>Previo al desembolso del crédito grupal, EL GRUPO dejaría el
    10% cómo garantía del crédito, de haberse cancelado la totalidad del crédito de devolverá la garantía y en caso de
    incumpliendo de las cuotas del crédito, la garantía compensará al saldo vencido del crédito.<br><br>QUINTO,
    CRONOGRAMA DE PAGOS: Grupo CrediPalmo entregará a EL GRUPO, un CRONOGRAMA DE PAGO GRUPAL del crédito aprobado, el
    ...
    parte conjunta con el presente contrato. <br>El cronograma de pagos individual es la expresión de manera
    ...
    de pagos individual afectará al cronograma grupal. <br>El cronograma de pagos individual contendrá los intereses,
    ...
    cláusula. <br>Asimismo, en caso de cuotas vencidas, Grupo CrediPalmo realizará la compensación con la cuenta de
    ...
    CrediPalmo.<br>Los pagos que realice EL GRUPO en virtud del Contrato se aplicarán en el orden siguiente: a)
    intereses compensatorios; b) interés moratorio que cumpla con el criterio indicado en el párrafo precedente, en caso
    corresponda; c) gastos - comisiones y d) capital.<br>La entidad financiera se encuentra prohibida de realizar
    ...
    vigente.<br><br>SEXTO, SOBRE EL ADELANTO DE CUOTAS: EL GRUPO podrán realizar pagos por encima de la cuota exigible
    ...
    las siguientes condiciones:<br>Se considerará Pago Anticipado, cuando el pago es mayor de dos cuotas, que incluye
    aquella exigible en el periodo, y trae como consecuencia la aplicación del monto al capital del crédito, con la
    consiguiente reducción de los intereses, las comisiones y los gastos al día del pago. <br>Los Pagos Anticipados
    disminuirán el monto de las cuotas o el plazo del pago, a elección de EL GRUPO, debiendo realizar dicha indicación
    al momento de comunicar su intención de realizar el Pago Anticipado, el cual constará en documento proporcionado por
    Grupo CrediPalmo. <br>Si el Pago Anticipado fuere realizado por una tercera persona o existieran dificultades para
    ...
    cláusula, la reducción del número de cuotas, todo esto de acuerdo a lo establecido en el numeral 29.3 del Reglamento
    ...
    Transparencia. <br>Grupo CrediPalmo, a solicitud de EL GRUPO, procederá a emitir nuevo cronograma de pagos con el
    ...
    del periodo a las cuotas inmediatas siguientes.<br>Se considera Adelanto de Cuotas a los pagos efectuados por EL
    ...
    en el numeral 4.1 de la presente cláusula.<br><br>SEPTIMO, INTERESES, COMISIONES Y GASTOS: La tasa de interés
    compensatorio, moratorio o penalidad, comisiones y gastos que Grupo CrediPalmo aplicará al saldo deudor de EL GRUPO,
    ...
    de la Resolución SBS N° 8181-2012 (Reglamento de Transparencia de Información y Contratación con Usuarios del
    Sistema Financiero). <br>Asimismo, las partes entenderán por TEA a la tasa de costo efectivo anual que permite
    ...
    aplicables.<br><br>OCTAVO, CESIÓN DE POSICIÓN CONTRACTUAL: Grupo CrediPalmo podrá ceder sus derechos y/o su posición
    ...
    los mecanismos previstos en la cláusula Décimo Quinta.<br>NOVENO, MODIFICACIONES CONTRACTUALES: - Queda expresamente
    ...
    medios de comunicación directos establecidos en la cláusula sexta, con 45 días de anticipación. <br>Las tasas de
    interés podrán ser modificadas en los siguientes casos: <br>1. Por novación de la obligación, conforme a las
    disposiciones del Código Civil. <br>2. De mutuo acuerdo con EL GRUPO como resultado de una efectiva negociación
    entre las partes. <br>3. Cuando la Superintendencia, previo informe favorable del Banco Central de Reserva del Perú,
    ...
    Consumidor en Materia de Servicios Financieros, Ley N° 28587 y sus normas modificatorias. <br>4. En forma unilateral
    ...
    así se precise o requiera por mandato de las normas legales vigentes. <br>Cuando se trate de modificaciones
    ...
    del cliente, vía correos electrónicos, redes sociales o anotaciones en comprobantes de pagos.<br>DECIMO, RESOLUCIÓN
    DEL CONTRATO: EL GRUPO podrá poner término a este Contrato cuando así lo decida, dando aviso a Grupo CrediPalmo, sin
    perjuicio de su obligación de pagar de manera inmediata el Saldo Deudor total de EL CRÉDITO que liquide Grupo
    CrediPalmo. Grupo CrediPalmo podrá mantener vigente EL CRÉDITO hasta la cancelación total del Saldo Deudor.<br>El
    plazo del Contrato es a plazo fijo; sin embargo, Grupo CrediPalmo podrá dar por vencidos todos los plazos y/o
    resolver de pleno derecho el Contrato desde la fecha que señale en la comunicación que se realice a EL GRUPO
    previamente, sin necesidad de declaración judicial, en los siguientes casos: <br>Si EL GRUPO: (i) no paga en la
    ...
    cualquier otra situación mediante la cual se suspenden sus pagos.<br>Si cualquier obligación crediticia de EL GRUPO
    ...
    del presente Contrato.<br>Si mantener vigente EL CRÉDITO implica el incumplimiento de las políticas corporativas de
    Grupo CrediPalmo o de alguna disposición legal, en especial aquellas referidas a políticas crediticias o de lavado
    de activos y financiamiento del terrorismo.<br>Por cese o fallecimiento de miembros de EL GRUPO. <br>Si EL GRUPO no
    cuenta con un seguro de desgravamen vigente en los términos previstos en el presente documento.<br>Si EL GRUPO
    incumple cualquiera de las obligaciones que asumen en el presente Contrato y/o atenta contra las políticas internas
    que tiene Grupo Credipalmo en cada uno de sus canales o plataformas.<br>Si Grupo CrediPalmo considera que no resulta
    ...
    disposición.<br>Mantiene saldos menores en beneficio de Grupo CrediPalmo y éste sobre la base de sus políticas
    internas decide condonar dichos montos. <br>Para los supuestos enunciados, Grupo CrediPalmo, dependiendo de la
    ...
    través de los medios directos previamente a la resolución. <br>En este caso, EL GRUPO deberá pagar de manera
    ...
    según la liquidación que realice Grupo CrediPalmo.<br><br>DÉCIMO PRIMERO, DE LOS RETIROS DE ALGUN INTEGRANTE U OTRO
    SUPUESTO: De conformidad con la Resolución S.B.S. N° 4174-2015, Reglamento de Créditos Grupales Solidarios y sus
    ...
    Resumen y Cartilla de Identificación.<br>En caso de fallecimiento o invalidez de sus miembros, EL GRUPO deberá
    comunicar de ello a Grupo CrediPalmo; debiendo tener en cuenta el procedimiento aplicable para dichos casos, que se
    encuentra más a detalle ara llegar toda la información por parte de Grupo CrediPalmo<br>DÉCIMO SEGUNDO, INCAPACITAD
    PARA FIRMAR: En caso algún integrante de EL GRUPO sea iletrado y/o tenga incapacidad para firmar y el monto otorgado
    ...
    encargo.<br>DÉCIMO TERCERO, NORMAS: De conformidad con lo establecido en el artículo 85 del Código de Protección y
    ...
    podrá resolverlo sin comunicación previa; en los siguientes casos: <br>Cuando en cumplimiento de las normas
    ...
    poniendo en riesgo el pago de las obligaciones derivadas del presente contrato. <br>Por consideraciones del perfil
    de actividad de EL GRUPO vinculadas al Sistema de Prevención del Lavado de Activos y Financiamiento del Terrorismo.
    <br>En los casos de falta de transparencia de EL GRUPO, cuando se compruebe, como resultado de la evaluación
    ...
    modificaciones contractuales o la resolución del contrato, conforme a lo indicado en esta cláusula.<br>DÉCIMO
    CUARTO, PAGARÉ: EL GRUPO declaran haber emitido pagarés incompletos, cuya copia les ha sido entregada a la
    ...
    totales o parciales que se anoten en el Pagaré, aun cuando no estén suscritas por ellos.<br>Se deja expresa
    constancia que de conformidad con lo dispuesto por el artículo 1279° del Código Civil, la emisión del pagare a que
    ...
    Valor.<br><br>DÉCIMO QUINTO, CAMBIO DE DOMICILIO: Para los fines del presente contrato de préstamo, las partes
    ...
    domicilio.<br>Las partes acuerdan que en tanto no se comunique por escrito el cambio de domicilio de cualquiera de
    ...
    de recibido el comunicado de variación de cualquiera de las partes.<br><br>DÉCIMO SEXTO, SOLUCIÓN DE CONTROVERSIAS:
    ...
    elección de cualquiera de las partes, podrá optar por accionar y someterse ante:<br>El Poder Judicial de la ciudad
    donde firmen el Contrato.<br>Sede Arbitral, siendo que EL GRUPO podrá elegir dicha modalidad de resolución de
    controversias, siendo obligatorio para Grupo CrediPalmo aceptar someterse a dicha vía cuando sea elegida por EL
    GRUPO. <br>Por su parte, en los casos que Grupo CrediPalmo solicite la utilización de la vía arbitral, no será
    obligatorio para EL GRUPO someterse a dicha vía. Grupo CrediPalmo pone a disposición de EL GRUPO la atención de
    reclamos mediante los siguientes canales: <br>De manera presencial a través de cualquiera de nuestras agencias a
    ...
    mismas.<br><br>Firmado en ………………… el …… del mes de ……. de 202…<br><br><br><br><br><br><br><br><br><br>
</body>
