...
<body>
    ...
    <div class="content">
        ...
        <p>Le solicitamos que en conjunto con su grupo, puedan regularizar esta situación en el menor plazo posible, y
            ...
            cumplimiento puntual de los pagos del crédito hace posible estar bien calificadas en las centrales de riesgo
            y puedan acceder a más créditos.</p>

        <p>Para mayor información puede acercarse a nuestra oficina ubicada en la Jr. Tahuantinsuyo N° 164 - Tarapoto.
            o comunicarse con su asesor al telefono {{ $responsable->telefono ?? 'N/A' }}.</p>
    </div>
</body>
