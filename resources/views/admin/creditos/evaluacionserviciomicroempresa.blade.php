                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td
                                    class="{{ $prestamo->destino !== 'activo fijo' && abs($rentabilidad_ventas - $margenventas) > 5 ? 'text-danger' : '' }}">
                                    {{ $rentabilidad_ventas }}%</td>
                            ...
                            <tr>
                                ...
                                <td>Liquidez</td>
                                <td
                                    class="{{ $prestamo->destino !== 'activo fijo' && $liquidez <= 1 ? 'text-danger' : '' }}">
                                    {{ $liquidez }}</td>
                            ...
                            <tr>
                                ...
                                <td>ROA (%)</td>
                                <td class="{{ $prestamo->destino !== 'activo fijo' && $roa <= 5 ? 'text-danger' : '' }}">
                                    {{ $roa }}%</td>
                            ...
                            <tr>
                                ...
                                <td>ROE (%)</td>
                                <td class="{{ $prestamo->destino !== 'activo fijo' && $roe <= 10 ? 'text-danger' : '' }}">
                                    {{ $roe }}%</td>
                            ...
                            <tr>
                                ...
                                <td
                                    class="{{ $prestamo->destino !== 'activo fijo' && $indice_endeudamiento > 40 ? 'text-danger' : '' }}">
            ...
            <div class="col-md-12 mb-5">
                ...
                <div class="form-group">
                    ...
                    <textarea name="comentarioadministrador" id="comentarioadministrador" class="form-control" rows="3"
                        style="color: black;" required><?php if (isset($comentarioasesor) && !empty($comentarioasesor)) {
