                        ...
                        {{-- <div class="card card-outline card-primary" id="detalle_negocio">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-2"><button type="button" onclick="agregarProducto()" class="btn btn-primary">Añadir Producto</button></div>
                                </div>
                        ...
                        {{-- <div class="card card-outline card-warning" id="inventario_producto">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <button type="button" onclick="agregarInventario()" class="btn btn-warning">Añadir Producto</button>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="documento_identidad" value="{{ old('documento_identidad') }}" name="documento_identidad" class="form-control">
                                        </div>
                                    </div>
