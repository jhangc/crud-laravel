                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="{{ $saldo_final <= $cuotaprestamo ? 'text-danger' : '' }}">{{ $saldo_final }}
                                </td>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="{{ $prestamo->destino !== 'activo fijo' && abs($rentabilidad_ventas - $margenventas) > 5 ? 'text-danger' : '' }}">
                            ...
                            <tr>
                                ...
                                <td class="{{ $prestamo->destino !== 'activo fijo' && $capital_trabajo <= $totalprestamo ? 'text-danger' : '' }}">
                                    {{ $capital_trabajo }}</td>
