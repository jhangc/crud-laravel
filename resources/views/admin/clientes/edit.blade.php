                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ $cliente->actividad_economica }}"
                                        name="actividad_economica" class="form-control">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="sexo" id="sexo" class="form-control" required>
                                        ...
                                        <option value="Masculino" {{ $cliente->sexo == 'Masculino' ? 'selected' : '' }}>
                                            Masculino</option>
                                        <option value="Femenino" {{ $cliente->sexo == 'Femenino' ? 'selected' : '' }}>
                                            Femenino</option>
                                    </select>
                                    @error('sexo')
                                        <small style="color: red">{{ $message }}</small>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ $cliente->direccion_laboral }}"
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ $cliente->referencia }}" name="referencia"
                                        class="form-control">
                                    @error('referencia')
                                        <small style="color: red">{{ $message }}</small>
                                    @enderror
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ $cliente->lugar_nacimiento }}" name="lugar_nacimiento"
                                        class="form-control" required>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="date" value="{{ $cliente->fecha_nacimiento }}"
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ $cliente->profesion }}" name="profesion"
                                        class="form-control" required>
                                    @error('profesion')
                                        <small style="color: red">{{ $message }}</small>
                                    @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="estado_civil" id="estado_civil" class="form-control" required>
                                        ...
                                        <option value="Soltero"
                                            {{ $cliente->estado_civil == 'Soltero' ? 'selected' : '' }}>Soltero</option>
                                        <option value="Casado" {{ $cliente->estado_civil == 'Casado' ? 'selected' : '' }}>
                                            Casado</option>
                                        <option value="Conviviente"
                                            {{ $cliente->estado_civil == 'Conviviente' ? 'selected' : '' }}>Conviviente
                                        </option>
                                        <option value="Divorciado"
                                            {{ $cliente->estado_civil == 'Divorciado' ? 'selected' : '' }}>Divorciado
                                        </option>
                                    </select>
                                    @error('estado_civil')
                                        <small style="color: red">{{ $message }}</small>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ $cliente->conyugue }}" name="conyugue"
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ $cliente->dni_conyugue }}" name="dni_conyugue"
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ $cliente->direccion_conyugue }}"
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ $cliente->aval }}" name="aval" id="aval"
                                        class="form-control">
                                    @error('aval')
                                        <small style="color: red">{{ $message }}</small>
                                    @enderror
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ $cliente->numero_dni_aval }}" name="numero_dni_aval"
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ $cliente->direccion_aval }}" name="direccion_aval"
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    @if ($cliente->dni_aval)
                                        <a href="{{ asset('storage/' . $cliente->dni_aval) }}" target="_blank">Ver DNI del Aval</a>
                                    @endif
                                    @error('dni_aval')
                                        <small style="color: red">{{ $message }}</small>
                                    @enderror
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    @if ($cliente->foto)
                                        <a href="{{ asset('storage/' . $cliente->foto) }}" target="_blank">Ver Foto</a>
                                    @endif
                                    @error('foto')
                                        <small style="color: red">{{ $message }}</small>
                                    @enderror
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    @if ($cliente->dni_pdf)
                                        <a href="{{ asset('storage/' . $cliente->dni_pdf) }}" target="_blank">Ver DNI en PDF</a>
                                    @endif
                                    @error('dni_pdf')
                                        <small style="color: red">{{ $message }}</small>
                                    @enderror
