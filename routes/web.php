...
// Reversiones de Crédito Individual (solo Administrador)
Route::get('admin/pagos/reversar-individual', [CreditoController::class, 'indexReversarPagoIndividual'])->name('pagos.index-reversar-individual')->middleware(['auth', 'role:Administrador']);
Route::post('admin/pagos/pago/{pago}/reversar-individual', [CreditoController::class, 'reversarPagoIndividual'])->name('pagos.reversar-individual')->middleware(['auth', 'role:Administrador']);
...
Route::post('admin/pagos/restablecer/{reversion}', [CreditoController::class, 'restablecerPago'])->name('pagos.restablecer')->middleware(['auth', 'role:Administrador']);
